...
public class RedisUtil {
    ...
    public boolean add(String key, Object value) {
        ...
        try {
            ...
            LOGGER.error("add key [{}], val [{}]", key, value, e);
        }
        return result;
    }
    ...
    public boolean add(String key, Object value, int minute) {
        ...
        try {
            ...
            LOGGER.error("add key [{}], val [{}], expire [{}]", key, value, minute, e);
        }
    ...
    public  boolean set(String key, Object value) {
        ...
        try {
            ...
            LOGGER.error("set key [{}], val [{}]", key, value, e);
        }
        return result;
    }
    ...
    public  boolean replace(String key, Object value) {
        ...
        try {
            ...
            LOGGER.error("replace key [{}], val [{}]", key, value, e);
        }
    ...
    public  boolean replace(String key, Object value, int minute) {
        ...
        try {
            ...
            LOGGER.error("replace key [{}], val [{}], expire [{}]", key, value, minute, e);
        }
    ...
    public boolean clear(String pattern) {
        try {
            ...
            LOGGER.error("delete keys [{}]", pattern, e);
    ...
    public boolean ttl(String pattern) {
        try {
            ...
            LOGGER.error("ttl keys [{}]", pattern, e);
